 ...
 */
?>
<section class="search-form home-two-search">
   		<div class="container">
        	<div class="row">
        	 <?php if ($form=='1' ) {?> 
            <form action="<?php echo esc_url(home_url( '/' )); ?>" method="get" class="form-inline">
                <fieldset>
                    <div class="input-group">
                        <input type="text" name="s" autocomplete="off" <?php if($auto_on=='1'){?>id="s"<?php }?> placeholder="<?php esc_html_e("What do you want to learn today?",'educationpress'); ?>" value="<?php the_search_query(); ?>" class="form-control" />
