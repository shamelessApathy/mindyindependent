            ...
            <div class="container">
				...
				?>	
                        <div class="col-xs-12 col-sm-2 teacher">
                            <a href="<?php echo esc_url( do_shortcode( '[instructor_profile_url instructor_id="' . $user->ID . '"]' )); ?>"><?php echo get_avatar( $user->ID, 300);?></a>
                            <h4><a href="<?php echo esc_url( do_shortcode( '[instructor_profile_url instructor_id="' . $user->ID . '"]' )); ?>"><?php echo esc_html($user->display_name);?> </a></h4>
