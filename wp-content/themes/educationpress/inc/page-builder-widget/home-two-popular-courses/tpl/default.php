<?php
/*
 * Popular Online Courses For Home Page Two
 */
 global $educationpress_options,$instructor_profile_slug;
?>
<section class="popular-courses home-two-pop-courses">
       		<div class="container">
            	<div class="row">
                ...
                <div class="col-xs-12 col-sm-4 zoom">
                    ...
                    <span></span></div>
                    <?php }?>
                    <h3><a href="<?php echo esc_url(get_permalink($popular_course->ID)); ?>"><?php $title = ( mb_strlen( get_the_title( $popular_course->ID) ) >= 65 ) ? mb_substr( get_the_title( $popular_course->ID), 0, 65 ) . '...' : get_the_title( $popular_course->ID);
