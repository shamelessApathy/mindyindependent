...
?>
<?php
if( !class_exists( 'Home_One_Search_Form_Widget' ) ):
class Home_One_Search_Form_Widget extends SiteOrigin_Widget {
	function __construct() {

    parent::__construct(
        'home-one-search-form',

        esc_html__('Home One Search Form', 'educationpress'),


        array(
            'description' => esc_html__('Home page one search form with icons.', 'educationpress'),
		...
		array(
            'title' => array(
                ...
                'default' => esc_html__('Emerge yourself by learning new Skills', 'educationpress'),
            ),
			'form' => array(
                'type' => 'radio',
...
siteorigin_widget_register('home-one-search-form', __FILE__, 'Home_One_Search_Form_Widget');
endif;
?>