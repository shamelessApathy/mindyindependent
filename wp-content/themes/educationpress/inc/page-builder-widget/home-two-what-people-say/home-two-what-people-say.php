...
?>
<?php
if( !class_exists( 'Home_Two_What_People_Say_Widget' ) ):

class Home_Two_What_People_Say_Widget extends SiteOrigin_Widget {
	function __construct() {

    parent::__construct(
        'home-two-what-people-say',

        esc_html__('Home Two What People Say', 'educationpress'),

        array(
            'description' => esc_html__('What People Say for home page two', 'educationpress'),
...
siteorigin_widget_register('home-two-what-people-say', __FILE__, 'Home_Two_What_People_Say_Widget');
endif;
?>