 ...
 */
?>
<style type="text/css">.flexslider .btn-default {color:<?php echo $button_color?> !important; background:<?php echo $button_bgcolor?>; border-color:<?php echo $button_bgcolor?>;}.flexslider .btn-default:hover { color:<?php echo $button_hover_color?> !important; background:<?php echo $button_hover_bgcolor?>;border-color:<?php echo $button_hover_bgcolor?>; }
<?php 
if( $text_in_slide == 'no'  )
{
?>
...
?>
 ...
 data-slider_animation="<?php echo $slider_animation;?>"  data-slider_direction="<?php echo $slider_direction;?>"  data-slider_show_speed="<?php echo intval( $slider_show_speed );?>"     data-slider_animation_speed="<?php echo intval( $slider_animation_speed );?>" data-slider_slide_show="<?php echo intval( $slider_slide_show );?>"
	  ...
	  ?>
			<!-- #item start -->
			<li <?php if (!empty( $slider_image )){?>style="background:<?php echo esc_url($slider_bg_color);?> url(<?php echo esc_url($slider_image[0]);?>) no-repeat center; background-size:cover; "
				<?php }?>>
            	 <?php 
