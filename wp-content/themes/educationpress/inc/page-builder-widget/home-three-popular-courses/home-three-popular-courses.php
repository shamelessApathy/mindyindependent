...
?>
<?php
if( !class_exists( 'Home_Three_Popular_Courses_Widget' ) ):


class Home_Three_Popular_Courses_Widget extends SiteOrigin_Widget {
	function __construct() {
		
    parent::__construct(
        'home-three-popular-courses',

        esc_html__('Home Three Popular Courses', 'educationpress'),

        array(
            'description' => esc_html__('Popular Courses for home page three', 'educationpress'),
...
siteorigin_widget_register('home-three-popular-courses', __FILE__, 'Home_Three_Popular_Courses_Widget');
endif;
