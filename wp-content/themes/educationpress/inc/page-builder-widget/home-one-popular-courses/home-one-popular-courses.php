...
if( !class_exists( 'Home_One_Popular_Courses_Widget' ) ):

class Home_One_Popular_Courses_Widget extends SiteOrigin_Widget {
	function __construct() {
		
    parent::__construct(
        'home-one-popular-courses',

        esc_html__('Home One Popular Courses', 'educationpress'),

        array(
            'description' => esc_html__('Popular Courses for home page one', 'educationpress'),
...
siteorigin_widget_register('home-one-popular-courses', __FILE__, 'Home_One_Popular_Courses_Widget');
endif;
?>