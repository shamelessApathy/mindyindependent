...
add_action( 'tgmpa_register', 'educationpress_register_required_plugins' );
/**
 ...
 */
function educationpress_register_required_plugins() {
	/*
	...
	$plugins = array(
	   ...
	   // Rich Reviews plugin is required for review and ratting
        array(
            'name' => 'Rich Reviews',
            'slug' => 'rich-reviews',
            'required' => false,
        ...
        array(
		 ...
		 array(
            'name'      => 'CoursePress Pro',
            'slug'      => 'coursepress', // The plugin slug (typically the folder name).
            'source'    => get_template_directory() . '/inc/plugins/coursepress.zip', // The plugin source.
            'required'  => true, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '2.1.1',
		 ...
		 array(
            ...
            'source'    => get_template_directory() . '/inc/plugins/marketpress.zip', // The plugin source.
            'required'  => true, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '3.2.7',
			'force_deactivation' => true,
        ),
		...
		array(
            'name'      => 'Redux Extensions Loader',
            'slug'      => 'extension-loader', // The plugin slug (typically the folder name).
            'source'    => get_template_directory() . '/inc/plugins/extension-loader.zip', // The plugin source.
			'version'            => '1.1',
            'required'  => true, // If false, the plugin is only 'recommended' instead of required.
			'force_activation'   => false,
            'force_deactivation' => true,
