...
<header id="masthead" class="site-header <?php if( edupress_is_sticky_header() 
   ...
   <!-- header_meta #start -->
  <?php get_template_part( 'partials/ecom-header/header-meta-two' );?>
  <!-- header_meta #end -->
  ...
  <div class="container">
    ...
    <!-- #site-navigation #start --> 
	 ...
	 {
		 get_template_part( 'partials/ecom-header/nav-menu-two' );
	 }?>
    <!-- #site-navigation  #end--> 
    </div> <!--row #end--> 
  </div> <!--container #end--> 
  ...
  <div class="menu-full">
        <div class="container">
            <div class="row nav-menu-two">
                <?php get_template_part( 'partials/ecom-header/nav-menu-two' );?>
            </div> <!--row #end--> 
        </div> <!--container #end--> 
    </div> <!-- menu-full #end -->
    <?php
