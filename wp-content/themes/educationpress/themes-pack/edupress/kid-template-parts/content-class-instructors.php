...
<?php
	global $edupress_options;
			 $instructors = edupress_kid_get_class_instructors( get_the_ID() );
                    ...
                    ?>
                     ...
                     <section class="courses-instructor clearfix">
                            ...
                            <h3><?php esc_html_e( 'ABOUT TEACHER', 'edupress' ); ?></h3>
                     			<?php 
                                ...
                                <div class="row instructor-single">
                                 ...
                                 <div class="col-xs-12 col-sm-9">                     	
                                        <h3 class="inst-name"><?php echo (edupress_kid_get_instructor_link($instructor->display_name)); ?></h3>
