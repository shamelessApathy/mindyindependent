...
<div class="site-branding col-xs-12 col-sm-3">
     ...
     <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php  if(is_page_template( 'page-templates/home.php' )){ if($post->post_name=='home-page-2' && !is_front_page()) { echo get_template_directory_uri()."/images/uni/logo_2.png"; }elseif($post->post_name=='home-page-1' && !is_front_page() ){ echo get_template_directory_uri()."/images/uni/logo.png";}else{ echo esc_url( $edupress_options['edupress_logo']['url'] );}}else{ echo esc_url( $edupress_options['edupress_logo']['url'] ); } ?>" class="brand" alt="<?php echo esc_attr( $edupress_site_name ); ?>" /> </a>
     <?php }else{?>
