...
function edupress_university_remove_widgets($widgets){
	unset($widgets['edupress_kid_Search_Cat_Filter_Widget']);
	unset($widgets['edupress_kid_Search_Cat_List_Widget']);
	unset($widgets['edupress_kid_Course_Search_Widget']);
	
	unset($widgets['edupress_kid_Similar_Classes_Widget']);
	unset($widgets['edupress_kid_Recent_Classes_Widget']);
...
function edupress_university_unregister_widgets()
{
	...
	if ($pagenow == 'widgets.php'){
		...
		unregister_widget('Edupress_Kid_Home_One_Slider_Widget');
		unregister_widget('Edupress_Kid_Home_Two_Slider_Widget');
		unregister_widget('Edupress_Kid_Home_One_Slider_Widget');
		unregister_widget('Edupress_Kid_Home_Image_Slider_Widget' );		
		unregister_widget('Edupress_Kid_Home_One_Features_Widget' );
		unregister_widget('Edupress_Kid_Home_One_Gallery_Widget' );
		unregister_widget('Edupress_Kid_Home_One_Classes_Widget' );
		unregister_widget('Edupress_Kid_Home_Two_Classes_Widget' );
		unregister_widget('Edupress_Kid_Home_One_Blog_Widget');
		unregister_widget('Edupress_Kid_Home_Two_Blog_Widget');		
		unregister_widget('Edupress_Kid_Home_One_Teachers_Widget' );
		unregister_widget('Edupress_Kid_Home_Two_Teachers_Widget' );
		unregister_widget('Edupress_Kid_Home_Two_Timetable' );
		
		unregister_widget('Edupress_Kid_Home_One_Features_Widget');
		
		unregister_widget('Edupress_Kid_Home_What_People_Say_Widget');
		unregister_widget('Edupress_Kid_Home_Text_Banner_Widget');
		
		unregister_widget('Edupress_Kid_Home_Two_Upcoming_Event_Widget');
		unregister_widget('Edupress_Kid_Home_Two_Contact_Widget');
		
		
		unregister_widget('SiteOrigin_Widget_PriceTable_Widget');
		unregister_widget('Edupress_Kid_Home_What_People_Say_Widget');
		
		unregister_widget('Edupress_Kid_About_US_How_It_Works_Widget');
		unregister_widget('Edupress_Kid_About_US_Meet_Our_Teachers_Widget');
		unregister_widget('Edupress_Kid_About_US_Partnering_With_Us_Widget');
...
function edupress_university_filter_active_widgets($active){
	...
	$active['edupress-kid-home-one-slider'] = true;
	$active['edupress-kid-home-two-slider'] = true;
	$active['edupress-kid-home-image-slider'] = true;
	$active['edupress-kid-home-one-features'] = true;
	$active['edupress-kid-home-one-gallery'] = true;
	$active['edupress-kid-home-one-classes'] = true;
	$active['edupress-kid-home-two-classes'] = true;
	$active['edupress-kid-home-one-event'] = true;
	$active['edupress-kid-home-one-blog'] = true;
	$active['edupress-kid-home-two-blog'] = true;
	$active['edupress-kid-home-one-teachers'] = true;
	$active['edupress-kid-home-two-teachers'] = true;
	$active['edupress-kid-home-two-time-table'] = true;
	$active['edupress-kid-home-two-features'] = true;
	
	$active['edupress-kid-home-two-upcoming-event'] = true;
	$active['edupress-kid-home-two-contact'] = true;

	$active['edupress-kid-home-text-banner'] = true;
	$active['edupress-university-home-partners'] = true;
	$active['edupress-kid-home-what-people-say'] = true;
	
	$active['edupress-kid-aboutus-how-it-works'] = true;
	$active['edupress-kid-aboutus-meet-our-teachers'] = true;
	$active['edupress-kid-aboutus-partnering-with-us'] = true;
...
function edupress_university_add_widget_tabs($tabs) {
	$tabs[] = array(
        ...
        'filter' => array(
            'groups' => array('edupresskidhome1')
        )
    );
	 $tabs[] = array(
        'title' => esc_html__('Home Page Two', 'edupress'),
        'filter' => array(
            'groups' => array('edupresskidhome2')
        )
    );
	 $tabs[] = array(
        'title' => esc_html__('Home Page Three', 'edupress'),
        'filter' => array(
            'groups' => array('edupresskidhome3')
        )
    );
    ...
    $layouts['home-page1'] = array(
        ...
        'widgets' => 
				...
				dictum sapien in augue consequat.',
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_Kid_Home_One_Slider_Widget',
						'grid' => 0,
						'cell' => 0,
						'id' => 0,
						'style' => 
				...
				printer took a galley of type.',
					...
					array (
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_Kid_Home_What_People_Say_Widget',
						'raw' => false,
						'grid' => 0,
						'cell' => 0,
						'id' => 7,
		 ...
		 'widgets' => 
				  array (
					...
					array (
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_Kid_Home_Two_Slider_Widget',
						'grid' => 0,
						'cell' => 0,
						'id' => 0,
						'style' => 
