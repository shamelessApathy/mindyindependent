...
?>
<?php
if( !class_exists( 'Edupress_Kid_About_US_Meet_Our_Teachers_Widget' ) ):

class Edupress_Kid_About_US_Meet_Our_Teachers_Widget extends SiteOrigin_Widget {
	function __construct() {

    parent::__construct(
        'edupress-kid-aboutus-meet-our-teachers',
...
siteorigin_widget_register('edupress-kid-aboutus-meet-our-teachers', __FILE__, 'Edupress_Kid_About_US_Meet_Our_Teachers_Widget');
endif;
?>