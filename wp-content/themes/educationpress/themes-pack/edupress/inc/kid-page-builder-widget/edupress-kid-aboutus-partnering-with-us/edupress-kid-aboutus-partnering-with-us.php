...
?>
<?php
if( !class_exists( 'Edupress_Kid_About_US_Partnering_With_Us_Widget' ) ):

class Edupress_Kid_About_US_Partnering_With_Us_Widget extends SiteOrigin_Widget {
	function __construct() {

    parent::__construct(
        'edupress-kid-aboutus-partnering-with-us',
...
siteorigin_widget_register('edupress-kid-aboutus-partnering-with-us', __FILE__, 'Edupress_Kid_About_US_Partnering_With_Us_Widget');
endif;
?>