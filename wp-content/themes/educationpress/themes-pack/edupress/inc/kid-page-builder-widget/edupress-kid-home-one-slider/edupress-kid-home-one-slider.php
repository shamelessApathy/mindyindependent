...
?>
<?php
if( !class_exists( 'Edupress_Kid_Home_One_Slider_Widget' ) ):
class Edupress_Kid_Home_One_Slider_Widget extends SiteOrigin_Widget {

	function __construct() {

    parent::__construct(
        'edupress-kid-home-one-slider',
		...
		'slider_one' => array(
			...
			'fields' => array(
				...
				'slider_title' => array(
					...
					'default' =>  esc_html('An Innovative Kindergarten of Theology'),
					'state_handler' => array(
	...
	function get_template_variables( $instance, $args ){
		...
		return array(
			...
			*/
			...
			'title_color' => !empty($instance['title_color']) ? $instance['title_color'] : '#333',
...
siteorigin_widget_register('edupress-kid-home-one-slider', __FILE__, 'Edupress_Kid_Home_One_Slider_Widget');
endif;
?>