...
?>
<?php
if( !class_exists( 'Edupress_Kid_About_US_How_It_Works_Widget' ) ):
class Edupress_Kid_About_US_How_It_Works_Widget extends SiteOrigin_Widget {
	function __construct() {
	global $signup_url;
    parent::__construct(
        'edupress-kid-aboutus-how-it-works',
		...
		array(
			...
			'desc' => array(
				...
				'default' => esc_html('Quisque varius vitae dolor eget pellentesque Integer ultricies velitleo vestibulum feugiat mauris sollicitudin porttitor finibus liqultrices metus.'),
...
siteorigin_widget_register('edupress-kid-aboutus-how-it-works', __FILE__, 'Edupress_Kid_About_US_How_It_Works_Widget');
endif;
?>