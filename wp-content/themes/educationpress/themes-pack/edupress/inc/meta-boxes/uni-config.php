...
if( !function_exists( 'edupress_university_register_meta_boxes' ) ) 
{
    ...
    function edupress_university_register_meta_boxes ( $meta_boxes ) {
        ...
        $meta_boxes[] = array(
            ...
            'pages'     => array( 'page','post', 'event', 'campus' ),
		 ...
		 $meta_boxes[] = array(
            ...
            'priority'  => 'low',
            'show'   => array(
                'template'    => array( 'uni-page-templates/tpl-our-techers.php'),
            ),
            'fields' => array(
                array(
...
/*
add_action( 'rwmb_campus-post-type-meta-box_after_save_post' , 'edupress_university_save_campus_gallery');
function edupress_university_save_campus_gallery() {
	if( !empty( $_POST['EDU_PRESS_campus_gallery'] ))
		
		update_post_meta( intval($_POST['post_ID']), 'EDU_PRESS_campus_gallery', implode(',',$_POST['EDU_PRESS_campus_gallery']));
	else
		delete_post_meta( intval($_POST['post_ID']), 'EDU_PRESS_campus_gallery');
