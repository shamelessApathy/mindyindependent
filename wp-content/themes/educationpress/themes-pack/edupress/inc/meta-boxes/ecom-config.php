...
if( !function_exists( 'edupress_woo_register_meta_boxes' ) ) {
    /**
     ...
     * @since 1.0.0
     */
    function edupress_woo_register_meta_boxes ( $meta_boxes ) {
        ...
        $meta_boxes[] = array(
		 ...
		 $meta_boxes[] = array(
            ...
            'priority'  => 'low',
            'show'   => array(
                'template'    => array( 'ecom-page-templates/tpl-our-techers.php'),
            ),
            'fields' => array(
                array(
    ...
    add_filter( 'rwmb_meta_boxes', 'edupress_woo_register_meta_boxes' );
