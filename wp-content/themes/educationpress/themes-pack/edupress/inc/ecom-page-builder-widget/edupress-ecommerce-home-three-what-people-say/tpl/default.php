 				...
 				<div class="col-xs-12 text-center">
                	<blockquote class="testimonial">
                         ...
                         <div class="text-center col-xs-12">
                                ...
                                <a href="<?php echo  esc_html(get_post_meta( get_the_ID(), 'EDU_PRESS_testimonials_url', true )) ;?>" title="<?php the_title_attribute(); ?>">
                                <?php the_post_thumbnail(array(70,70)); ?>
                                </a>
                            <p class="meta"><strong><?php the_title(); ?></strong>
                            <cite><?php echo  esc_html(get_post_meta( get_the_ID(), 'EDU_PRESS_testi_job_title', true ));?></cite></p>
                            	</div>
