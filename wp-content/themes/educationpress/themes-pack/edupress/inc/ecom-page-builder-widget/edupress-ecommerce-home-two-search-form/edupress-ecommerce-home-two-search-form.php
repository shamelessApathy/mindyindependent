...
?>
<?php
if( !class_exists( 'Edupress_Ecommerce_Home_Two_Search_Form_Widget' ) ):

class Edupress_Ecommerce_Home_Two_Search_Form_Widget extends SiteOrigin_Widget {
	function __construct() {

    parent::__construct(
        'edupress-ecommerce-home-two-search-form',

        esc_html__('Home Two Search Form', 'edupress'),


        array(
            'description' => esc_html__('Home page two search form with icons.', 'edupress'),
		...
		array(
            'title' => array(
                ...
                'default' => esc_html__('Learn New Skills', 'edupress'),
            ),
			'form' => array(
                'type' => 'radio',
...
siteorigin_widget_register('edupress-ecommerce-home-two-search-form', __FILE__, 'Edupress_Ecommerce_Home_Two_Search_Form_Widget');
endif;
?>