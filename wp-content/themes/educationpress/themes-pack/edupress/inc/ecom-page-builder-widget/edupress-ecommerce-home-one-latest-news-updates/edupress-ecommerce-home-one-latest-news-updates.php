...
?>
<?php
if( !class_exists( 'Edupress_Ecommerce_Home_One_Latest_News_Updates_Widget' ) ):

class Edupress_Ecommerce_Home_One_Latest_News_Updates_Widget extends SiteOrigin_Widget {
	function __construct() {
		
    parent::__construct(
        'edupress-ecommerce-home-one-latest-news-updates',

        esc_html__('Home One Latest News & Updates', 'edupress'),

        array(
            'description' => esc_html__('Latest News & Updates for home page one', 'edupress'),
...
siteorigin_widget_register('edupress-ecommerce-home-one-latest-news-updates', __FILE__, 'Edupress_Ecommerce_Home_One_Latest_News_Updates_Widget');
endif;
?>