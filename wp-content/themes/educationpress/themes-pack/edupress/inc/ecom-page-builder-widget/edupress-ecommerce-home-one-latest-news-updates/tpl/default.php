                  ...
                  <?php  if ( ! empty( $title ) ) {?>
                        ...
                        <div class="articel-list">
                            ...
                            <?php }?>
									...
									<p class="meta"><?php edupress_posted_on() ?></p>
                                    <a href="<?php the_permalink() ?>" class="img-thumb">
                                    <figure>
                                    <?php
									 if ( has_post_thumbnail() ) {
										            if($number_of_posts!=3 && ($recp==1 || $recp==2 || $recp==6 || $recp==7)){
                                                    the_post_thumbnail('edupress-ecommerce-home-thumbnail1');
													}
													if($number_of_posts==3){
														if($recp==1)
														 the_post_thumbnail('edupress-ecommerce-home-thumbnail3');
														 
														 if($recp==2 || $recp==3)
														 the_post_thumbnail('edupress-ecommerce-home-thumbnail4');
