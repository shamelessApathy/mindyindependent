...
<section class="search-category">
			...
			// 6 categries start 
			if(count( $course_cat)>1 && term_exists( (int)$course_cat[0], 'product_cat') ){
			?>
            <div class="col-xs-12 col-sm-6" >
                <?php if(count( $course_cat)>1 &&  term_exists( (int)$course_cat[0], 'product_cat')){
					$course_cat1 = get_term_by('id', (int)  $course_cat[0], 'product_cat');
            	...
            	<div class="cat cat_first" <?php if( !empty($bg_style) ) echo 'style="' . esc_attr(implode(';', $bg_style)) . '"' ?>>
                	<h3><a href="<?php echo  esc_url(get_term_link( (int) $course_cat1->term_id,'product_cat'));?>"><?php echo esc_html($course_cat1->name);?></a></h3>
                   <?php $cat_short_text1 =  get_term_meta($course_cat1->term_id,'ec_cat_short_text');
                ...
                <?php }?>
                <?php if(count( $course_cat )>=2 && term_exists( (int)$course_cat[1], 'product_cat')){
					$course_cat2 = get_term_by('id', (int) $course_cat[1], 'product_cat');
                ...
                <div class="cat cat_second" <?php if( !empty($bg_style) ) echo 'style="' . esc_attr(implode(';', $bg_style)) . '"' ?>>
                	<h3><a href="<?php echo  esc_url(get_term_link( (int) $course_cat2->term_id,'product_cat'));?>"><?php 
                    ...
                    <?php
					$cat_short_text_arr2 = get_term_meta($course_cat2->term_id,'ec_cat_short_text');
            ...
            <?php if(count( $course_cat )>=3 &&  term_exists( (int)$course_cat[2], 'product_cat')){?>
            <div class="col-xs-12 col-sm-6" >
             <?php if(count( $course_cat )>=3){
					$course_cat3 = get_term_by('id', (int) $course_cat[2], 'product_cat');
            	 ...
            	 <div class="cat cat_third" <?php if( !empty($bg_style) ) echo 'style="' . esc_attr(implode(';', $bg_style)) . '"' ?>>
                	<h3><a href="<?php echo  esc_url(get_term_link( (int) $course_cat3->term_id,'product_cat'));?>"><?php 
                    ...
                    <?php
					$cat_short_text_arr3 =get_term_meta($course_cat3->term_id,'ec_cat_short_text');
                 ...
                 <?php }?>
                <?php if(count( $course_cat )>=4 && term_exists( (int)$course_cat[0], 'product_cat')){
					$course_cat4 = get_term_by('id', (int) $course_cat[3], 'product_cat');
                ...
                <div class="cat cat_forth" <?php if( !empty($bg_style) ) echo 'style="' . esc_attr(implode(';', $bg_style)) . '"' ?>>
                	<h3><a href="<?php echo  esc_url(get_term_link( (int) $course_cat4->term_id,'product_cat'));?>"><?php 
                    ...
                    <?php
					$cat_short_text_arr4 = get_term_meta($course_cat4->term_id,'ec_cat_short_text');
                ...
                <?php }?>
                  <?php if(count( $course_cat )>=5 && term_exists( (int)$course_cat[4], 'product_cat')){
					$course_cat5 = get_term_by('id', (int) $course_cat[4], 'product_cat');
                ...
                <div class="cat cat_fifth" <?php if( !empty($bg_style) ) echo 'style="' . esc_attr(implode(';', $bg_style)) . '"' ?>>
                	<h3><a href="<?php echo  esc_url(get_term_link((int) $course_cat5->term_id,'product_cat'));?>"><?php
					$course_cattext5 = ( mb_strlen( $course_cat5->name ) >= 15 ) ? mb_substr( $course_cat5->name, 0, 13 ) . '..' : $course_cat5->name;
                     ...
                     <?php
					 $cat_short_text_arr5 = get_term_meta($course_cat5->term_id,'ec_cat_short_text');
                ...
                <?php }?>
                 <?php if(count( $course_cat )>=6 &&  term_exists( (int)$course_cat[5], 'product_cat')){
					$course_cat6 = get_term_by('id', (int) $course_cat[5], 'product_cat');
                ...
                <div class="cat cat_sixth" <?php if( !empty($bg_style) ) echo 'style="' . esc_attr(implode(';', $bg_style)) . '"' ?>>
                	<h3><a href="<?php echo   esc_url(get_term_link((int) $course_cat6->term_id,'product_cat'));?>"><?php 
                    ...
                    <?php
					$cat_short_text_arr6 = get_term_meta($course_cat6->term_id,'ec_cat_short_text');
            ...
            <div class="col-xs-12 col-sm-6" >
                <?php if(count( $course_cat )>=7 && term_exists( (int)$course_cat[6], 'product_cat')){
					$course_cat7 = get_term_by('id', (int) $course_cat[6], 'product_cat');
            	...
            	<div class="cat cat_first cat_seventh" <?php if( !empty($bg_style) ) echo 'style="' . esc_attr(implode(';', $bg_style)) . '"' ?>>
                	<h3><a href="<?php echo  esc_url(get_term_link( (int) $course_cat7->term_id,'product_cat'));?>"><?php echo esc_html($course_cat7->name);?></a></h3>
                    <?php $cat_short_text7 =  get_term_meta($course_cat7->term_id,'ec_cat_short_text');
                ...
                <?php }?>
                <?php if(count( $course_cat)>=8 && term_exists( (int)$course_cat[7], 'product_cat')){
					$course_cat8 = get_term_by('id', (int) $course_cat[7], 'product_cat');
                ...
                <div class="cat cat_second cat_eighth" <?php if( !empty($bg_style) ) echo 'style="' . esc_attr(implode(';', $bg_style)) . '"' ?>>
                	<h3><a href="<?php echo  esc_url(get_term_link( (int) $course_cat8->term_id,'product_cat'));?>"><?php 
                    ...
                    <?php 
					$cat_short_text_arr8 =  get_term_meta($course_cat8->term_id,'ec_cat_short_text');
            ...
            <?php if(count( $course_cat)>=9 && term_exists( (int)$course_cat[8], 'product_cat')){?>
            <div class="col-xs-12 col-sm-6" >
             <?php if(count( $course_cat)>=9){
					$course_cat9 = get_term_by('id', (int) $course_cat[8], 'product_cat');
            	 ...
            	 <div class="cat cat_third cat_nine" <?php if( !empty($bg_style) ) echo 'style="' . esc_attr(implode(';', $bg_style)) . '"' ?>>
                	<h3><a href="<?php echo  esc_url(get_term_link( (int) $course_cat9->term_id,'product_cat'));?>"><?php
					$course_cattext9 = ( mb_strlen( $course_cat9->name ) >= 32 ) ? mb_substr( $course_cat9->name, 0, 29 ) . '..' : $course_cat9->name;
                     ...
                     <?php 
					$cat_short_text_arr9 =  get_term_meta($course_cat9->term_id,'ec_cat_short_text');
                 ...
                 <?php }?>
                <?php if(count( $course_cat )>=10 && term_exists( (int)$course_cat[9], 'product_cat')){
					$course_cat10 = get_term_by('id', (int) $course_cat[9], 'product_cat');
                ...
                <div class="cat cat_forth cat_ten" <?php if( !empty($bg_style) ) echo 'style="' . esc_attr(implode(';', $bg_style)) . '"' ?>>
                	<h3><a href="<?php echo  esc_url(get_term_link( (int) $course_cat10->term_id,'product_cat'));?>"><?php
					$course_cattext10 = ( mb_strlen( $course_cat10->name ) >= 15 ) ? mb_substr( $course_cat10->name, 0, 13 ) . '..' : $course_cat10->name;
                     ...
                     <?php 
					$cat_short_text_arr10 =  get_term_meta($course_cat10->term_id,'ec_cat_short_text');
                ...
                <?php }?>
                  <?php if(count( $course_cat )>=11 && term_exists( (int)$course_cat[10], 'product_cat')){
					$course_cat11 = get_term_by('id', (int) $course_cat[10], 'product_cat');
                ...
                <div class="cat cat_fifth cat_eleven" <?php if( !empty($bg_style) ) echo 'style="' .esc_attr( implode(';', $bg_style)) . '"' ?>>
                	<h3><a href="<?php echo  esc_url(get_term_link((int) $course_cat11->term_id,'product_cat'));?>"><?php
					$course_cattext11 = ( mb_strlen( $course_cat11->name ) >= 15 ) ? mb_substr( $course_cat11->name, 0, 13 ) . '..' : $course_cat11->name;
                     ...
                     <?php 
					$cat_short_text_arr11 =  get_term_meta($course_cat11->term_id,'ec_cat_short_text');
                ...
                <?php }?>
                 <?php if(count( $course_cat )>=12 && term_exists( (int)$course_cat[11], 'product_cat')){
					$course_cat12 = get_term_by('id', (int) $course_cat[11], 'product_cat');
                ...
                <div class="cat cat_sixth cat_twelve" <?php if( !empty($bg_style) ) echo 'style="' . esc_attr(implode(';', $bg_style)) . '"' ?>>
                	<h3><a href="<?php echo  esc_url(get_term_link((int) $course_cat12->term_id,'product_cat'));?>"><?php 
					...
					echo esc_html($course_cattext12);?></a></h3>
                     <?php 
					$cat_short_text_arr12 =  get_term_meta($course_cat12->term_id,'ec_cat_short_text');
			...
			<?php 
			// 18 categories start
			if(count( $course_cat )>=13 && term_exists( (int)$course_cat[12], 'product_cat')){  ?>
            <div class="row"> <!-- row #start 18 categories-->
            <div class="col-xs-12 col-sm-6" >
                <?php if(count( $course_cat )>=13){
					$course_cat13 = get_term_by('id', (int) $course_cat[12], 'product_cat');
            	...
            	<div class="cat cat_first cat_thirteen" <?php if( !empty($bg_style) ) echo 'style="' . esc_attr(implode(';', $bg_style)) . '"' ?>>
                	<h3><a href="<?php echo  esc_url(get_term_link( (int) $course_cat13->term_id,'product_cat'));?>"><?php echo esc_html($course_cat13->name);?></a></h3>
                    <?php $cat_short_text13 =  get_term_meta($course_cat13->term_id,'ec_cat_short_text');
                ...
                <?php }?>
                <?php if(count( $course_cat )>=14 && term_exists( (int)$course_cat[13], 'product_cat')){
					$course_cat14 = get_term_by('id', (int) $course_cat[13], 'product_cat');
                ...
                <div class="cat cat_second cat_fourteen" <?php if( !empty($bg_style) ) echo 'style="' . esc_attr(implode(';', $bg_style)) . '"' ?>>
                	<h3><a href="<?php echo  esc_url(get_term_link( (int) $course_cat14->term_id,'product_cat'));?>"><?php 
					...
					echo esc_html($course_cattext14);?></a></h3>
                     <?php 
					$cat_short_text_arr14 =  get_term_meta($course_cat14->term_id,'ec_cat_short_text');
            ...
            <div class="col-xs-12 col-sm-6" >
             <?php if(count( $course_cat )>=15  && term_exists( (int)$course_cat[14], 'product_cat')){
					$course_cat15 = get_term_by('id', (int) $course_cat[14], 'product_cat');
            	 ...
            	 <div class="cat cat_third cat_fifteen" <?php if( !empty($bg_style) ) echo 'style="' . esc_attr(implode(';', $bg_style)) . '"' ?>>
                	<h3><a href="<?php echo  esc_url(get_term_link( (int) $course_cat15->term_id,'product_cat'));?>"><?php 
					...
					echo esc_html($course_cattext15);?></a></h3>
                     <?php 
					$cat_short_text_arr15 =  get_term_meta($course_cat15->term_id,'ec_cat_short_text');
                 ...
                 <?php }?>
                <?php if(count( $course_cat )>=16  && term_exists( (int)$course_cat[15], 'product_cat')){
					$course_cat16 = get_term_by('id', (int) $course_cat[15], 'product_cat');
                ...
                <div class="cat cat_forth cat_sixteen" <?php if( !empty($bg_style) ) echo 'style="' . esc_attr(implode(';', $bg_style)) . '"' ?>>
                	<h3><a href="<?php echo   esc_url(get_term_link( (int) $course_cat16->term_id,'product_cat'));?>"><?php 
					...
					echo esc_html($course_cattext16) ;?></a></h3>
                     <?php 
					$cat_short_text_arr16 =  get_term_meta($course_cat16->term_id,'ec_cat_short_text');
                ...
                <?php }?>
                  <?php if(count( $course_cat )>=17  && term_exists( (int)$course_cat[16], 'product_cat')){
					$course_cat17 = get_term_by('id', (int) $course_cat[16], 'product_cat');
                ...
                <div class="cat cat_fifth cat_seventeen" <?php if( !empty($bg_style) ) echo 'style="' . esc_attr(implode(';', $bg_style)) . '"' ?>>
                	<h3><a href="<?php echo   esc_url(get_term_link((int) $course_cat17->term_id,'product_cat'));?>"><?php
					$course_cattext17 = ( mb_strlen( $course_cat17->name ) >= 15 ) ? mb_substr( $course_cat17->name, 0, 13 ) . '..' : $course_cat17->name;
                     ...
                     <?php 
					$cat_short_text_arr17 =  get_term_meta($course_cat17->term_id,'ec_cat_short_text');
                ...
                <?php }?>
                 <?php if(count( $course_cat )>=18  && term_exists( (int)$course_cat[18], 'product_cat')){
					$course_cat18 = get_term_by('id', (int) $course_cat[17], 'product_cat');
                ...
                <div class="cat cat_sixth cat_eighteen" <?php if( !empty($bg_style) ) echo 'style="' . esc_attr(implode(';', $bg_style)) . '"' ?>>
                	<h3><a href="<?php echo  esc_url(get_term_link((int) $course_cat18->term_id,'product_cat'));?>"><?php 
                    ...
                    <?php 
					$cat_short_text_arr18 =  get_term_meta($course_cat18->term_id,'ec_cat_short_text');
