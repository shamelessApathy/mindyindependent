...
<section class="meet-teachers">
            <div class="container">
				...
				$author_ids = edupress_ecommerce_get_author_id_of_product();
				...
				?>	
                        <div class="col-xs-12 col-sm-2 teacher">
                            <a href="<?php echo esc_url(home_url('/'.$edupress_ecommerce_instructor_slug.'/'.$instructor->display_name)); ?>"><?php echo get_avatar( $user->ID, 300);?></a>
                            <h4><a href="<?php echo esc_url(home_url('/'.$edupress_ecommerce_instructor_slug.'/'.$instructor->display_name)); ?>"><?php echo esc_html($user->display_name);?> </a></h4>
