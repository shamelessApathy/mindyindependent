...
if( !class_exists( 'Edupress_Ecommerce_About_US_How_It_Works_Widget' ) ):
class Edupress_Ecommerce_About_US_How_It_Works_Widget extends SiteOrigin_Widget {
	function __construct() {
	global $signup_url;
    parent::__construct(
        'edupress-ecommerce-aboutus-how-it-works',
...
siteorigin_widget_register('edupress-ecommerce-aboutus-how-it-works', __FILE__, 'Edupress_Ecommerce_About_US_How_It_Works_Widget');
endif;
?>