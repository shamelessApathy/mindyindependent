                 ...
                 <?php if(count($newspost)>$tm){?>
                     <article class="col-xs-12 col-sm-4 zoom">
                    	<div class="news">
                            ...
                            <p class="meta"><?php esc_html_e('by:','edupress');?> <a href="<?php echo esc_url( get_author_posts_url( $newspost[$tm]->post_author ) );?>"><?php echo esc_html(get_the_author_meta( 'display_name', $newspost[$tm]->post_author )); ?></a> <?php esc_html_e('. in:','edupress');?> <a href="<?php echo esc_url( get_category_link( $newscat[0]->term_id ) );?>"><?php echo esc_html( $newscat[0]->name );?></a></p>
