...
?>
<?php
if( !class_exists( 'Edupress_Ecommerce_Home_One_Slider_Widget' ) ):

class Edupress_Ecommerce_Home_One_Slider_Widget extends SiteOrigin_Widget {

	function __construct() {

    parent::__construct(
        'edupress-ecommerce-home-one-slider',
		...
		'slider_one' => array(
			...
			'fields' => array(
				'slider_image' => array(
					...
					'fallback' => true,
					'description' => esc_html__('Image size should be width of 1970px and height of 810px', 'edupress'),
				),			
				'slider_tag' => array(
					'type' => 'text',
					'label' => esc_html__( 'Tagline', 'edupress' ),
					'state_handler' => array(
		...
		*/
		...
		'tag_bgcolor' => array(
			'type' => 'color',
			'label' => __( 'Tagline Background Color', 'edupress' ),
			'default' => '#0583e4',
			'state_handler' => array(
							'text_in_slide[yes]' => array('show'),
							 '_else[text_in_slide]' =>  array('hide'),
...
siteorigin_widget_register('edupress-ecommerce-home-one-slider', __FILE__, 'Edupress_Ecommerce_Home_One_Slider_Widget');
endif;
?>