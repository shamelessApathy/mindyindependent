...
?>
<?php
if( !class_exists( 'Edupress_Ecommerce_Home_Two_Popular_Courses_Widget' ) ):

class Edupress_Ecommerce_Home_Two_Popular_Courses_Widget extends SiteOrigin_Widget {
	function __construct() {
	
    parent::__construct(
        'edupress-ecommerce-home-two-popular-courses',

        esc_html__('Home Two Popular Courses', 'edupress'),

        array(
            'description' => esc_html__('Popular Courses for home page two', 'edupress'),
...
siteorigin_widget_register('edupress-ecommerce-home-two-popular-courses', __FILE__, 'Edupress_Ecommerce_Home_Two_Popular_Courses_Widget');
endif;
?>