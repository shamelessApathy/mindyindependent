<?php
/*
Widget Name: Home One Popular Courses 
Description: Popular Courses for home page one'.
Author: ThemeCycle
...
?>
<?php
if( !class_exists( 'Edupress_Ecommerce_Home_One_Popular_Courses_Widget' ) ):

class Edupress_Ecommerce_Home_One_Popular_Courses_Widget extends SiteOrigin_Widget {
	function __construct() {
		
    parent::__construct(
        'edupress-ecommerce-home-one-popular-courses',

        esc_html__('Home One Popular Courses', 'edupress'),

        array(
            'description' => esc_html__('Popular Courses for home page one', 'edupress'),
	...
	if( get_option( 'woocommerce_enable_review_rating' ) !== 'yes' ) {
		unset( $field_array[ 'course_orderby' ][ 'options' ][ 'ratings' ] );
		$field_array[ 'course_orderby' ][ 'options' ] = 'date';
	}
	return $field_array;
...
siteorigin_widget_register('edupress-ecommerce-home-one-popular-courses', __FILE__, 'Edupress_Ecommerce_Home_One_Popular_Courses_Widget');
endif;
?>