 ...
 */
global $opt_name;
add_filter('redux/options/'. $opt_name .'/sections', 'edupress_ecommerce_add_social_share_section', 30); 
function edupress_ecommerce_add_social_share_section( $sections ){
