<?php
if ( !class_exists( 'edupress_kid_Similar_Classes_Widget' ) ) {
    class edupress_kid_Similar_Classes_Widget extends WP_Widget {

        public function __construct(){
            $widget_ops = array(
                'classname' => 'widget_courses',
                'description' => esc_html__('Displays similar classes in class detail page sidebar.','edupress')
            );
            parent::__construct( 'edupress_kid_Similar_Classes_Widget', esc_html__('Similar Classes','edupress'), $widget_ops );
        }
			...
			*/
            ...
            if( $featured_query->have_posts() ):
                ...
                <ul>
                    <?php
                    echo '<li>';
                    esc_html_e('No similar classes found!', 'edupress');
                    echo '</li>';
                    ?>
                </ul>
                <?php
        ...
        {
            $instance = wp_parse_args( (array) $instance, array( 'title' => 'Similar Classes', 'count' => 3 , 'sort_by' => 'random' ) );
...
if( !function_exists( 'edupress_kid_register_similar_classes_widget' ) ) :
    /**
     * Register similar classes widget
     */
    function edupress_kid_register_similar_classes_widget() {
        register_widget( 'edupress_kid_Similar_Classes_Widget' );
    }
    add_action( 'widgets_init', 'edupress_kid_register_similar_classes_widget' );
endif;
