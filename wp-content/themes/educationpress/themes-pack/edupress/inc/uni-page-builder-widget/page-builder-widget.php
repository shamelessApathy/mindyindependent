<?php
function edupress_university_remove_widgets($widgets){
	/*
	unset($widgets['edupress_university_Search_Cat_Filter_Widget']);
	unset($widgets['edupress_university_Search_Lang_Filter_Widget']);
	unset($widgets['edupress_university_Search_Price_Filter_Widget']);
	*/
	unset($widgets['edupress_university_Course_Search_Widget']);
	unset($widgets['edupress_university_Courses_Widget']);
	unset($widgets['edupress_university_Recent_Events_Widget']);
	unset($widgets['edupress_university_Recent_Posts_Widget']);
	unset($widgets['edupress_university_Similar_Courses_Widget']);
	
	unset($widgets['edupress_university_Social_Link_Widget']);
	unset($widgets['edupress_university_Footer_Contact_Widget']);
	
    return $widgets;
}
add_filter('siteorigin_panels_widgets', 'edupress_university_remove_widgets');
function edupress_university_unregister_widgets()
{
	global $pagenow;
	if ($pagenow == 'widgets.php'){
		
		unregister_widget('Edupress_University_Home_One_Slider_Widget');
		//unregister_widget('Edupress_University_Home_One_Latest_Event');
		unregister_widget('Edupress_University_Home_One_News');
		unregister_widget('edupress-university-home-one-announcements');
		unregister_widget('Edupress_University_Home_One_Menu_Widget');
		unregister_widget('Edupress_University_Home_One_Campus_Life');
		unregister_widget('Edupress_University_Home_One_What_People_Say_Widget');
		unregister_widget('Edupress_University_Home_One_Text_Banner_Widget');
		unregister_widget('Edupress_University_Home_One_Banner_With_Button_Widget');
		
		unregister_widget('Edupress_University_Home_Two_Campus_Announcements_Widget');
		unregister_widget('Edupress_University_Home_Two_Latest_Event');
		//unregister_widget('Edupress_University_Home_Two_Latest_News');
		unregister_widget('Edupress_University_Home_Two_Menu_Widget');
		unregister_widget('Edupress_University_Two_Home_Campus_Life');
		
		unregister_widget('Edupress_University_Home_Search_Course_Widget');
		unregister_widget('Edupress_University_Home_Partners');
		
		
		unregister_widget('SiteOrigin_Widget_PriceTable_Widget');
		unregister_widget('Edupress_University_About_US_How_It_Works_Widget');
		unregister_widget('Edupress_University_About_US_Meet_Our_Teachers_Widget');
		unregister_widget('Edupress_University_About_US_Partnering_With_Us_Widget');
		unregister_widget('Edupress_University_Home_One_Slider_Widget');
		unregister_widget('Edupress_University_Home_One_Upcoming_Event_Widget');
		unregister_widget('Edupress_University_Home_One_What_People_Say_Widget');
		unregister_widget('Edupress_University_Home_One_Why_Should_You_Choose');
		unregister_widget('Edupress_University_Home_Two_Slider_Widget');
	
	}
}
add_action( 'widgets_init','edupress_university_unregister_widgets', 11 );	
function edupress_university_add_widgets_collection($folders){
    $folders[] = get_template_directory() . '/inc/page-builder-widget/';
	return $folders;
}
add_filter('siteorigin_widgets_widget_folders', 'edupress_university_add_widgets_collection');


function edupress_university_filter_active_widgets($active){
	
	$active['edupress-university-home-one-slider'] = true;
	$active['edupress-university-home-one-news'] = true;
	$active['edupress-university-home-one-latest-event'] = true;
	$active['edupress-university-home-one-announcements'] = true;
	$active['edupress-university-home-one-menu'] = true;
	$active['edupress-university-home-one-campus-life'] = true;
	$active['edupress-ecommerce-home-one-what-people-say'] = true;
	$active['edupress-university-home-one-text-banner'] = true;
	$active['edupress-university-home-one-banner-with-button'] = true;
	
	$active['edupress-university-home-two-slider'] = true;
	$active['edupress-university-home-two-campus-announcements'] = true;
	$active['edupress-university-home-two-latest-event'] = true;
	$active['edupress-university-home-two-latest-news'] = true;
	$active['edupress-university-home-two-menu'] = true;
	$active['edupress-university-home-two-campus-life'] = true;
	$active['edupress-university-home-search-course'] = true;
	
	$active['edupress-university-home-partners'] = true;
	
	$active['edupress-university-home-one-search-form'] = true;
	$active['edupress-university-home-two-search-form'] = true;
	$active['edupress-university-home-one-search-by-category'] = true;


	$active['edupress-university-home-one-what-people-say'] = true;

	$active['edupress-university-aboutus-how-it-works'] = true;
	$active['edupress-university-aboutus-meet-our-teachers'] = true;
	$active['edupress-university-aboutus-partnering-with-us'] = true;
	    return $active;
}
add_filter('siteorigin_widgets_active_widgets', 'edupress_university_filter_active_widgets');

function edupress_university_add_widget_tabs($tabs) {
	$tabs[] = array(
        'title' => esc_html__('Home Page One', 'edupress'),
        'filter' => array(
            'groups' => array('edupressuniversityhome1')
        )
    );
	 $tabs[] = array(
        'title' => esc_html__('Home Page Two', 'edupress'),
        'filter' => array(
            'groups' => array('edupressuniversityhome2')
        )
    );
	 $tabs[] = array(
        'title' => esc_html__('Home Page Three', 'edupress'),
        'filter' => array(
            'groups' => array('edupressuniversityhome3')
        )
    );

    return $tabs;
}
add_filter('siteorigin_panels_widget_dialog_tabs', 'edupress_university_add_widget_tabs', 20);


function edupress_university_prebuilt_layouts($layouts){
    $layouts['home-page1'] = array(
        ...
        'widgets' => 
				...
				dictum sapien in augue consequat.',
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_University_Home_One_Slider_Widget',
						'grid' => 0,
						'cell' => 0,
						'id' => 0,
						'style' => 
					...
					array (
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_University_Home_One_Search_Form_Widget',
						'raw' => false,
						'grid' => 0,
						'cell' => 0,
						'id' => 1,
					...
					array (
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_University_Home_One_Sepretor_Widget',
						'raw' => false,
						'grid' => 0,
						'cell' => 0,
						'id' => 2,
					...
					array (
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_University_Home_One_Search_By_Category_Widget',
						'raw' => false,
						'grid' => 0,
						'cell' => 0,
						'id' => 3,
					...
					array (
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_University_Home_One_Popular_Courses_Widget',
						'raw' => false,
						'grid' => 0,
						'cell' => 0,
						'id' => 4,
				...
				printer took a galley of type.',
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_University_Home_One_Why_Should_You_Choose',
						'raw' => false,
						'grid' => 0,
						'cell' => 0,
						'id' => 5,
					...
					array (
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_University_Home_One_Latest_News_Updates_Widget',
						'raw' => false,
						'grid' => 0,
						'cell' => 0,
						'id' => 6,
					...
					array (
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_University_Home_One_What_People_Say_Widget',
						'raw' => false,
						'grid' => 0,
						'cell' => 0,
						'id' => 7,
					...
					array (
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_University_Home_One_Upcoming_Event_Widget',
						'raw' => false,
						'grid' => 1,
						'cell' => 0,
						'id' => 8,
					...
					array (
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_University_Home_One_Instructor_Week_Widget',
						'raw' => false,
						'grid' => 1,
						'cell' => 1,
						'id' => 9,
					...
					array (
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_University_Home_One_Free_Course_Week_Widget',
						'raw' => false,
						'grid' => 1,
						'cell' => 2,
						'id' => 10,
		 ...
		 'widgets' => 
				  array (
					...
					array (
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_University_Home_Two_Slider_Widget',
						'grid' => 0,
						'cell' => 0,
						'id' => 0,
						'style' => 
					...
					array (
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_University_Home_Two_Search_Form_Widget',
						'raw' => false,
						'grid' => 0,
						'cell' => 0,
						'id' => 1,
					...
					array (
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_University_Home_Two_Popular_Courses_Widget',
						'raw' => false,
						'grid' => 0,
						'cell' => 0,
						'id' => 2,
					...
					array (
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_University_Home_Two_What_People_Say_Widget',
						'raw' => false,
						'grid' => 0,
						'cell' => 0,
						'id' => 3,
					...
					array (
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_University_Home_Two_Recent_Post_Widget',
						'raw' => false,
						'grid' => 1,
						'cell' => 2,
						'id' => 6,
		 ...
		 'widgets' => 
				  array (
					...
					array (
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_University_Home_Three_Browse_By_Category_Widget',
						'raw' => false,
						'grid' => 0,
						'cell' => 0,
						'id' => 0,
					...
					array (
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_University_Home_Three_Popular_Courses_Widget',
						'grid' => 0,
						'cell' => 0,
						'id' => 1,
						'style' => 
				...
				printer took a galley of type.',
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_University_Home_Three_Why_Should_You_Choose',
						'raw' => false,
						'grid' => 0,
						'cell' => 0,
						'id' => 2,
					...
					array (
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_University_Home_Three_Latest_News_Updates_Widget',
						'raw' => false,
						'grid' => 2,
						'cell' => 0,
						'id' => 6,
					...
					array (
					  ...
					  'panels_info' => 
					  array (
						'class' => 'Edupress_University_Home_Three_What_People_Say_Widget',
						'raw' => false,
						'grid' => 2,
						'cell' => 0,
						'id' => 7,
		 ...
		 'widgets' => 
			...
			<a class="btn btn-orange btn-large" href="#">View Online Courses <i class="lnr lnr-arrow-right"></i></a>',
				...
				array (
				  ...
				  'panels_info' => 
				  array (
					'class' => 'Edupress_University_About_US_How_It_Works_Widget',
					'raw' => false,
					'grid' => 1,
					'cell' => 0,
					'id' => 2,
				...
				array (
				  ...
				  'panels_info' => 
				  array (
					'class' => 'Edupress_University_About_US_Meet_Our_Teachers_Widget',
					'grid' => 2,
					'cell' => 0,
					'id' => 3,
					'style' => 
				...
				array (
				  ...
				  'panels_info' => 
				  array (
					'class' => 'Edupress_University_About_US_Partnering_With_Us_Widget',
					'grid' => 2,
					'cell' => 0,
					'id' => 4,
					'style' => 
...
add_filter('siteorigin_panels_prebuilt_layouts', 'edupress_university_prebuilt_layouts');
