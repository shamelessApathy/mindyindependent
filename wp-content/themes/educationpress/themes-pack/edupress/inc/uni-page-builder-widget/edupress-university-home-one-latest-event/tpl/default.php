<div class="col-xs-12 widget event-widget">
<header>
	<h3><?php echo esc_html( $title );?></h3>
	<a href="<?php echo get_post_type_archive_link( 'event' );?>" class="read-more">All Events<i class="fa fa-arrow-circle-o-right"></i></a>
