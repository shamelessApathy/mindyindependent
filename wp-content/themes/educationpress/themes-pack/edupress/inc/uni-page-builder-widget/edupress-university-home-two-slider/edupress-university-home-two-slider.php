...
?>
<?php
if( !class_exists( 'Edupress_University_Home_Two_Slider_Widget' ) ):
class Edupress_University_Home_Two_Slider_Widget extends SiteOrigin_Widget {

	function __construct() {

    parent::__construct(
        'edupress-university-home-two-slider',
		...
		'slider_one' => array(
			...
			'fields' => array(
				...
				'slider_title' => array(
					...
					'deafult' => esc_html('An Innovative Graduate University of Theology'),
					'state_handler' => array(
				...
				'slider_desc' => array(
					...
					'deafult' => esc_html('Filled with features for a school or university website'),
					'state_handler' => array(
							'text_in_slide[yes]' => array('show'),
							 '_else[text_in_slide]' =>  array('hide'),
					),
...
siteorigin_widget_register('edupress-university-home-two-slider', __FILE__, 'Edupress_University_Home_Two_Slider_Widget');
endif;
?>