...
?>
<?php
if( !class_exists( 'Edupress_University_Home_One_What_People_Say_Widget' ) ):
class Edupress_University_Home_One_What_People_Say_Widget extends SiteOrigin_Widget {
	function __construct() {

    parent::__construct(
        'edupress-university-home-one-what-people-say',
...
siteorigin_widget_register('edupress-university-home-one-what-people-say', __FILE__, 'Edupress_University_Home_One_What_People_Say_Widget');
endif;
?>