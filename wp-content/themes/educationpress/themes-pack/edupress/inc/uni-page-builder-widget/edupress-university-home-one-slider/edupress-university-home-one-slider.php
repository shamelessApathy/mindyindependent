...
?>
<?php
if( !class_exists( 'Edupress_University_Home_One_Slider_Widget' ) ):
class Edupress_University_Home_One_Slider_Widget extends SiteOrigin_Widget {

	function __construct() {

    parent::__construct(
        'edupress-university-home-one-slider',

        esc_html__('Home One Slider', 'edupress'),


        array(
            'description' => esc_html__('Home page One slider.', 'edupress'),
		...
		'slider_one' => array(
			...
			'fields' => array(
				...
				'slider_title' => array(
					...
					'default' => esc_html( 'An Innovative Graduate university of Theology'),
					'state_handler' => array(
				...
				'slider_desc' => array(
					...
					'default' =>  esc_html('It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.'),
					'state_handler' => array(
							'text_in_slide[yes]' => array('show'),
							 '_else[text_in_slide]' =>  array('hide'),
					),
...
siteorigin_widget_register('edupress-university-home-one-slider', __FILE__, 'Edupress_University_Home_One_Slider_Widget');
endif;
?>