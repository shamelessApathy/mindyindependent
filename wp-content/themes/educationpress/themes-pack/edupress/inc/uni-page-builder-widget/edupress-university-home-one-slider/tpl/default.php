...
?>
		 ...
		 <div class="flexslider university" data-slider_order="<?php echo $slider_order == 'random'?'true':'false';?>"
                 	...
                 	<div class="row">
                    	<div class="slide-caption">
                            ...
                            <?php }?>
                             ...
                             <a class="btn btn-medium btn-default" data-animation="animated zoomInUp" <?php if( isset( $slider['slider_newwindow'] ) && $slider['slider_newwindow']  ) { ?> target="_blank" <?php } ?> href="<?php echo esc_url($slider['slider_buttonurl']);?>"><?php echo esc_html($slider['slider_buttontext']);?> <i class="lnr lnr-arrow-right"></i></a>
                              <?php }?>
