...
?>
<?php
if( !class_exists( 'Edupress_University_About_US_Partnering_With_Us_Widget' ) ):
class Edupress_University_About_US_Partnering_With_Us_Widget extends SiteOrigin_Widget {
	function __construct() {

    parent::__construct(
        'edupress-university-aboutus-partnering-with-us',
...
siteorigin_widget_register('edupress-university-aboutus-partnering-with-us', __FILE__, 'Edupress_University_About_US_Partnering_With_Us_Widget');
endif;
?>