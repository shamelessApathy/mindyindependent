...
?>
<?php
if( !class_exists( 'Edupress_University_About_US_Meet_Our_Teachers_Widget' ) ):
class Edupress_University_About_US_Meet_Our_Teachers_Widget extends SiteOrigin_Widget {
	function __construct() {

    parent::__construct(
        'edupress-university-aboutus-meet-our-teachers',
...
siteorigin_widget_register('edupress-university-aboutus-meet-our-teachers', __FILE__, 'Edupress_University_About_US_Meet_Our_Teachers_Widget');
endif;
?>