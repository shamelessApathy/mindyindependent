<?php
if ( !class_exists( 'edupress_university_Course_Search_Widget' ) ) {
    class edupress_university_Course_Search_Widget extends WP_Widget {
        ...
        public function __construct(){
            ...
            parent::__construct( 'edupress_university_course_search_widget', esc_html__('Search Course','edupress'), $widget_ops );
        }
...
if( !function_exists( 'edupress_university_register_course_search_widget' ) ) :
    /**
     * Register course search widget
     */
    function edupress_university_register_course_search_widget() {
        register_widget( 'edupress_university_Course_Search_Widget' );
    }
    add_action( 'widgets_init', 'edupress_university_register_course_search_widget' );
endif;
