...
<div class="header_meta">
    <div class="container">
    <div class="row">
     <?php  if ( ! empty( $educationpress_options['educationpress_home_title'] ) ) {?>
      ...
      <nav class="meta-login">
		...
		?>
         ...
         <?php if (class_exists( 'CoursePress' )){
             ...
             <?php } else {?>
             <li><a href="<?php echo esc_url($signup_url);?>"><?php esc_html_e( 'Signup', 'educationpress' ); ?></a></li>	             <li><a href="<?php echo esc_url(cp_student_login_address());?>"><?php esc_html_e( 'Login', 'educationpress' ); ?></a></li>
              <?php }?>
		 <?php }else{
			  if ( is_user_logged_in() ) {?>
               <li><a href="<?php echo esc_url(wp_logout_url( site_url('/') ));?>"><?php esc_html_e( 'Log out', 'educationpress' ); ?></a></li>
