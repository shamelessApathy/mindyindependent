...
<header id="masthead" class="site-header <?php if( educationpress_is_sticky_header() ):?>header-stick<?php endif;?>">
  
   <!-- header_meta #start -->
  <?php get_template_part( 'partials/header/header-meta-two' );?>
  <!-- header_meta #end -->
  ...
  <div class="container">
    ...
    <!-- #site-navigation #start --> 
     <?php 
	 if($educationpress_options[ 'educationpress_menu_variation' ] == '1')
	 {
		 get_template_part( 'partials/header/nav-menu-two' );
	 }?>
    <!-- #site-navigation  #end--> 
    </div> <!--row #end--> 
  </div> <!--container #end--> 
 ...
 <!-- #site-navigation #start --> 
     <?php 
	 if($educationpress_options[ 'educationpress_menu_variation' ] == '2')
	 {?>
  <div class="menu-full">
        <div class="container">
            <div class="row nav-menu-two">
                <?php get_template_part( 'partials/header/nav-menu-two' );?>
            </div> <!--row #end--> 
        </div> <!--container #end--> 
    </div> <!-- menu-full #end -->
    <?php
