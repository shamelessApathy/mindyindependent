	...
	<div class="container">
    	<div class="row">
            ...
            <?php
						...
						printf( esc_html__( 'Author: %s', 'educationpress' ), get_the_author() );
					?>
                    </h1>
            </header><!-- .entry-header -->
        </div> <!--row #end  -->
...
<div class="page-spacer clearfix"> 
 <div id="primary">
        <div class="container">
        	<div class="row">
                <main id="main" class="site-main col-xs-12<?php echo esc_attr(educationpress_page_layout('educationpress_blogauthor_layout'));?>" >
