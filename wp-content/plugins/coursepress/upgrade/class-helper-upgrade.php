...
class CoursePress_Helper_Upgrade_1x_Data {
	...
	private static function update_course_meta( $course_id ) {
		$course_metas = array(
			...
			////Change transition by themecycle 
			//course_completion_content changed because if we remain it as blank, when course completed by student, he/she see blank screen. So, we need to chnge it by default content
			//'course_completion_content' => '',
			'course_completion_content' => __('<h3>Congratulations! You have successfully completed and passed COURSE_NAME!</h3><p>You can download your certificate here.</p><p>DOWNLOAD_CERTIFICATE_BUTTON</p>', 'cp'),
