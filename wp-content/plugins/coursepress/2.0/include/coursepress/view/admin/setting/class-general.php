						...
						<tbody>
							<tr valign="top" class="break">
								...
								<td>' . esc_html( trailingslashit( home_url() ) ) . '
									...
									<p class="description">' . esc_html__( 'Your course URL will look like: ', 'cp' ) . esc_html( trailingslashit( home_url() ) ) . esc_html( CoursePress_Core::get_setting( 'slugs/course', 'courses' ) ) . esc_html__( '/my-course/', 'cp' ) . '</p>
								</td>
							</tr>
							<tr valign="top" class="break">
